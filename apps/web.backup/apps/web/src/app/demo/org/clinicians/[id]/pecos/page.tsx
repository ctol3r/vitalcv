      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Medicare enrollment and revalidation status for clinician{' '}
            ...
            <div className="space-y-4">
              ...
              <section aria-labelledby="pecos-documents-heading">
                ...
                {summary.documents.length === 0 ? (
                  <p className="text-sm text-muted-foreground mt-2">No documents have been uploaded for this enrollment yet.</p>
                ) : (
              ...
              <div className="flex items-center gap-2 rounded-md bg-muted px-3 py-2 text-sm text-muted-foreground">
                ...
                <span>
                  Status last verified {formatDate(summary.lastCheckedAt)}. PECOS updates run daily at
                  02:00 PT.
                </span>
              </div>
            </div>
