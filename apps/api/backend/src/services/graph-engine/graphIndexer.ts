...
function mapEntityType(raw: string): NodeType {
  ...
  const map: Record<string, NodeType> = {
    ...
    decision: 'decision', taxonomy: 'taxonomy', state: 'state',
    trust_state: 'trust_state', exclusion: 'exclusion', enrollment: 'enrollment',
...
function mapEdgeType(raw: string): EdgeType {
  ...
  const map: Record<string, EdgeType> = {
    ...
    taxonomy_to_provider: 'taxonomy_to_provider',
    state_to_provider: 'state_to_provider',
    provider_to_trust_state: 'provider_to_trust_state',
