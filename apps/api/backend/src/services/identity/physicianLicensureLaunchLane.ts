    ...
    return {
      claims: [
        buildUnavailableLicensureClaim({
          ...
          reason: `${firstUnsupportedState} is outside the current physician licensure launch lane. Manual state board verification is required and is not decision-grade.`,
        }),
      ],
      launchState: null,
      route: 'unsupported',
