...
export const CONFORMANCE_TESTS: ConformanceTest[] = [
  ...
  // ── Trust state ───────────────────────────────────────────────────────
  {
    ...
    method: 'GET', path: '/api/trust-state/1003000126',
  ...
  },
  {
    ...
    method: 'GET', path: '/api/verify-professional/1003000126',
  ...
  // ── Decision Capsules ─────────────────────────────────────────────────
  {
    ...
    method: 'GET', path: '/api/decisions?npi=1003000126',
  ...
  },
  {
    ...
    method: 'GET', path: '/api/decisions/npi/1003000126/timeline',
  ...
  // ── Passport ──────────────────────────────────────────────────────────
  {
    ...
    method: 'GET', path: '/api/passport/1003000126',
  ...
  },
  {
    ...
    method: 'GET', path: '/api/passport/1003000126/trust',
  ...
  },
  {
    ...
    method: 'GET', path: '/api/passport/1003000126/disclose',
