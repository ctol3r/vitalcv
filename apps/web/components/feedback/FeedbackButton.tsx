...
export default function FeedbackButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-40 flex items-center gap-2 rounded-full bg-[var(--vt-accent-emerald)] px-4 py-2.5 text-xs font-medium text-white shadow-lg shadow-emerald-950/10 transition-all hover:scale-105 hover:bg-emerald-700 active:scale-95"
