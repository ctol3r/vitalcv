      ...
      <main className="mx-auto max-w-2xl space-y-6 px-4 py-10 pb-32">
        ...
        <section className="rounded-2xl border border-white/6 bg-[var(--vt-surface-dim)] px-5 py-4">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-foreground">
                A public preview of exactly what the clinician chose to share: current readiness, selected credentials, issuer provenance, and integrity details.
              </p>
          ...
          <p className="mt-3 text-xs text-muted-foreground">
            This link is a preview of what the clinician shared. If a row is pending, unavailable, or preview-only, the clinician still has work left and that row is context only. Sign in to continue to the employer review surface before treating any item as decision-grade or taking action on the candidate.
          </p>
        </section>
        ...
        <section className="overflow-hidden rounded-2xl border border-white/6 bg-[var(--vt-surface)]">
          <div className="border-b border-white/6 px-5 py-3">
            ...
            <p className="mt-1 text-sm text-foreground">
              Each row shows the credential type, issuing source, current availability, and the most recent verification timestamp included in this share. Pending, unavailable, or preview-only rows are not decision-grade.
            </p>
          </div>
