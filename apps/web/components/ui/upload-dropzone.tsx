      ...
      >
        ...
        <div className="flex flex-col items-center justify-center p-8 text-center">
          ...
          <div className="space-y-2">
            <p className="text-lg font-medium">{isDragActive ? "Drop files here" : "Upload documents"}</p>
            <p className="text-sm text-muted-foreground">Drag & drop files here, or click to select</p>
            <p className="text-xs text-muted-foreground">Supports PDF, DOC, DOCX up to {formatFileSize(maxSize)}</p>
          </div>
