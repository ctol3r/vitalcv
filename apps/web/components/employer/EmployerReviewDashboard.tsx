...
export function EmployerReviewDashboard({
  ...
  return (
    <div data-slot="employer-review-dashboard" className="w-full space-y-8">
      <div className="flex flex-col gap-6 border-b border-[var(--vt-border)] pb-8 md:flex-row md:items-end md:justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Clinician Packets</h2>
          <p className="mt-2 text-sm text-[var(--vt-text-muted)]">
      ...
      <div className="relative">
        <Search
          className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[var(--vt-text-muted)]"
          aria-hidden="true"
        />
        <Input
          type="text"
      ...
      {/* Filters */}
      <div className="flex flex-col items-start gap-4 rounded-sm border border-[var(--vt-border)] bg-[var(--vt-surface)] p-4 md:flex-row md:items-center">
        <div className="flex w-full items-center justify-between md:mr-4 md:w-auto">
          <div className="flex items-center gap-2 text-[var(--vt-text-muted)]">
        ...
        <div className="grid w-full flex-1 grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="flex flex-col gap-1">
            <label
              ...
              className="text-[9px] font-bold uppercase tracking-widest text-[var(--vt-text-muted)]"
            >
              Status
            </label>
            <select
              ...
              className="border-b border-[var(--vt-border)] bg-transparent py-2 font-mono text-xs focus:border-foreground focus:outline-none"
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none border-b border-[var(--vt-border)] bg-transparent py-2 pl-6 font-mono text-xs focus:border-foreground focus:outline-none"
              ...
              <Calendar
                className="absolute left-0 top-1/2 h-3 w-3 -translate-y-1/2 text-[var(--vt-text-muted)]"
                aria-hidden="true"
              />
            </div>
          </div>
      ...
      <div className="space-y-4">
        {filteredPackets.length === 0 ? (
          <div className="rounded-sm border border-dashed border-[var(--vt-border)] p-12 text-center text-[var(--vt-text-muted)]">
                ...
                <div className="flex flex-col justify-between gap-6 md:flex-row">
                  <div className="space-y-2">
                    <div className="flex items-center gap-3">
                      <h3 className="text-lg font-bold tracking-tight text-[var(--vt-text-primary)]">{packet.clinicianName}</h3>
                      <StatusBadge status={packet.status} />
                    </div>
                    <div className="flex items-center gap-4 font-mono text-[10px] text-[var(--vt-text-muted)]">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="hidden text-right sm:block">
                      <div className="text-[9px] font-bold uppercase tracking-widest text-[var(--vt-text-muted)]">
                        Est. Start
                      </div>
