...
function buildDemoData(): GlobalGraphData {
  const nodes: GlobalNode[] = [
    ...
    { id: 'c1', label: 'Example Clinician A', group: 'clinician', val: 3, x: 0, y: 0, vx: 0, vy: 0 },
    { id: 'c2', label: 'Example Clinician B', group: 'clinician', val: 3, x: 0, y: 0, vx: 0, vy: 0 },
    { id: 'c3', label: 'Example Clinician C', group: 'clinician', val: 3, x: 0, y: 0, vx: 0, vy: 0 },
