    ...
    <Figure
      ...
      narrow={
        <svg className="ezh-fig-narrow" viewBox="0 0 330 430" aria-hidden="true" focusable="false">
          ...
          <text x="312" y="110" fontSize="11.5" fill="currentColor" fillOpacity=".55" textAnchor="end">••• ••• ••••</text>
          ...
          <g className="ezh-rowfx" data-r="5">
            ...
            <text className="ezh-fig-hot-fill" x="24" y="407" fontSize="11.5">no source answered — only you can</text>
          </g>
        </svg>
      }
    />
