...
export const MOCK_GRAPH_DATA: XRayGraphData = {
  nodes: [
    ...
    { id: 'src:dea',      label: 'DEA Registration',         group: 1 },
    ...
    { id: 'claim:dea',    label: 'DEA Schedule II Auth.',    group: 2 },
  ],
  links: [
    { id: 'e1', source: 'npi:root',    target: 'src:nppes',    label: 'VERIFIED_BY'    },
    { id: 'e2', source: 'npi:root',    target: 'src:oig',      label: 'CHECKED_AGAINST' },
    { id: 'e3', source: 'npi:root',    target: 'src:dea',      label: 'REGISTERED_WITH' },
    { id: 'e4', source: 'npi:root',    target: 'src:statebrd', label: 'LICENSED_BY'    },
    { id: 'e5', source: 'src:nppes',   target: 'claim:active', label: 'SUPPORTS'       },
    { id: 'e6', source: 'src:oig',     target: 'claim:clear',  label: 'SUPPORTS'       },
    { id: 'e7', source: 'src:dea',     target: 'claim:dea',    label: 'SUPPORTS'       },
  ],
};
