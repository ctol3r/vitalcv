  ...
  return (
    <section ref={sectionRef} className="py-24 px-6 bg-slate-950">
      <div className="max-w-5xl mx-auto">
        <p className="text-teal-400 text-xs font-semibold uppercase tracking-widest scroll-animate">
          Architecture
        </p>
        <h2 className="mt-2 text-3xl md:text-4xl font-black text-white scroll-animate">
          Built on open standards.
        </h2>
        <p className="mt-3 text-lg text-slate-400 max-w-xl scroll-animate">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          {CARDS.map((card, index) => {
            ...
            // Compute a small delayed y transform based on index so they stack slightly
