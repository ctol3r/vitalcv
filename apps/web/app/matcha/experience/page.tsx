...
export const metadata: Metadata = {
  title: 'MATCHA — a preview of your signed-in experience',
  ...
  description:
    'See the MATCHA intelligence layer: your career end to end, a daily brief, and explained opportunity matches. Sample data.',
};
