...
function displayBand(band: TrustBand | undefined): string {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 font-mono text-sm sm:px-10 sm:py-20">
      ...
      {!loading && error && (
        <div className="mt-12 space-y-4">
          ...
          <p className="text-xs text-neutral-400">
            This page renders live trust-state data. Start the backend to see
            results.
          </p>
        </div>
      )}
          ...
          <section>
            ...
            <div className="mt-4 space-y-3">
              <div className="flex items-baseline justify-between">
                ...
                <span
                  className={`text-lg font-bold ${state.start_ready ? 'text-green-700' : 'text-red-700'}`}
                >
              ...
              <div className="flex items-baseline justify-between">
                ...
                <span
                  className={`text-lg font-bold ${bandColor(state.crs?.band)}`}
                >
                ...
                {state.acceptanceDetails && (
                  <dl className="mt-3 space-y-1.5 border-t border-neutral-100 pt-3">
                    <div className="flex gap-4">
                      ...
                      <dd className="text-neutral-950">
                        {state.acceptanceDetails.employerId}
                      </dd>
                    </div>
                    <div className="flex gap-4">
                      <dt className="w-28 shrink-0 text-neutral-500">
                      ...
                      <dd className="text-neutral-950">
                        {state.acceptanceDetails.facilityId}
                      </dd>
                    </div>
                    <div className="flex gap-4">
                      <dt className="w-28 shrink-0 text-neutral-500">
      ...
      <footer className="mt-10 border-t border-neutral-200 pt-6">
        <p className="text-xs text-neutral-400">
          This is a read-only verification result. No data was modified by
          viewing this page.
        </p>
      </footer>
    </main>
