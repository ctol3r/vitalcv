      ...
      <div className="mb-5">
        <LineageHeader
          ...
          slots={composeLineage({
            object: {
              label: 'Object',
              value: `Dossier · ${d.meta.subject}`,
              subLabel: `${d.meta.receiptCount} receipts · ${counts.satisfiedStandards}/${counts.totalStandards} standards`,
            },
            ownership: {
              label: 'Ownership',
              value: 'Delegated',
              subLabel: `generated by ${d.meta.generatedBy}`,
            },
            checkedAt: {
              label: 'checked_at',
            ...
            channel: {
              label: 'Channel',
              value: 'dossier · verifier zone',
              subLabel: d.meta.isDemo ? 'demo · stub signatures' : 'production',
            },
            replay: {
              label: 'Replay',
              value: chainOk ? 'chain-consistent' : 'chain broken',
              subLabel: chainOk ? 'σ ok' : 'σ defer',
            },
            runId: {
              label: 'run_id',
              value: d.meta.fileId,
              subLabel: 'dossier file id',
            },
          })}
        />
      </div>
