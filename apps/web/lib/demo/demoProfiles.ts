...
export const DEMO_PROFILES: Record<string, DemoProfile> = {
  '1003000126': {
    ...
    readiness: 'READY',
    readinessScore: 87,
    verifiedItems: ['NPI identity verified', 'OIG / LEIE clear', 'Medicare enrolled'],
    missingItems: [],
  ...
  '1942788324': {
    ...
    readiness: 'PARTIAL',
    readinessScore: 54,
    verifiedItems: ['NPI identity verified', 'OIG / LEIE clear'],
  ...
  '1841498016': {
    ...
    readiness: 'BLOCKED',
    readinessScore: 12,
    verifiedItems: ['NPI identity verified'],
    missingItems: [],
    gatedItems: ['State license - Nursys (access required)', 'FSMB board history (access required)'],
