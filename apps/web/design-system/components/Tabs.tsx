...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'inline-flex min-h-9 items-center justify-center rounded-[var(--vt-radius-pill)] px-[var(--vt-space-16)] text-[length:var(--vt-type-meta-size)] font-[var(--vt-font-weight-medium)] text-[var(--vt-text-secondary)]',
