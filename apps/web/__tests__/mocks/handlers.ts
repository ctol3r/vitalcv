  ...
  http.post("/api/upload/cv", async ({ request }) => {
    ...
    return HttpResponse.json({
      parsedData: {
        ...
        experience: "10 years",
        education: ["MD from Stanford University School of Medicine", "Residency at UCSF Medical Center"],
        certifications: ["Board Certified in Internal Medicine", "Advanced Cardiac Life Support (ACLS)"],
      },
    })
  }),
