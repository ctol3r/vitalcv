...
describe('Route role mapping', () => {
  ...
  const cases: Array<{
    ...
    // Verifier-continuity surfaces (institutional trust discovery — public by design).
    { path: '/trust', role: null, expected: 'allow' },
    { path: '/.well-known/jwks.json', role: null, expected: 'allow' },
    { path: '/.well-known/did.json', role: null, expected: 'allow' },
    { path: '/.well-known/openid-credential-issuer', role: null, expected: 'allow' },
    { path: '/.well-known/openid-configuration', role: null, expected: 'allow' },
    { path: '/.well-known/trust-register', role: null, expected: 'allow' },
    { path: '/api/receipt/1346053246', role: null, expected: 'allow' },
    { path: '/api/receipt/by-lineage/lin_v1_aaaabbbbccccdddd', role: null, expected: 'allow' },
