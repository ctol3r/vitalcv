...
description: Executes VitalCV waves with Claude Desktop as supervisor, Claude Code Terminal as builder, Codex as independent verifier and merge gate, and Browser/Cowork as optional QA. OpenClaw is paused unless the user explicitly restores it.
---
