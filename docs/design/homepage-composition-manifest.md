...
**Established:** 2026-07-20 (deep-audit W0.2) · **Rewritten:** 2026-08-08 (UX-V1 production cutover) · **Amended:** 2026-08-08 (D-01A homepage visual slice) · **Amended:** 2026-08-09 (roles band; UX-04 process story — glow placement now follows EC-20 A-1's "at most once per viewport" rather than D-01A's "work surface only")
