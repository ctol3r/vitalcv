// WAVE 1200 — UNIFIED ENTITY MODEL + REASONING LAYER
// (Wave 1100 graph, extended with a population roster, org pipelines, what-if
//  scenarios, graph-derived recommendations, and explainable reasoning traces.)
...
const ENTITY_TYPES = [
  { type: 'Person',        family: 'self',        count: 1,  note: 'The subject — the only writer of this ledger.', _w12: true },
