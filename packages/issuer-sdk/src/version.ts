export const SDK_NAME = '@vitalcv/issuer-sdk';
...
export function checkVersionCompatibility(apiVersion: string): CompatibilityResult {
  ...
  if (apiMajor > sdkMajor) return { compatible: true, warning: `API major ${apiMajor} ahead of SDK ${sdkMajor} — consider upgrading` };
