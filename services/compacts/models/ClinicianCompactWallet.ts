...
export function mergeWalletEntries(entries: ClinicianCompactWalletEntry[]): ClinicianCompactWalletEntry[] {
  ...
  for (const entry of entries) {
    ...
    byCompact.set(entry.compactType, {
      ...
      issuedAt: new Date(Math.min(toMillis(existing.issuedAt), toMillis(entry.issuedAt))),
