...
export const BoardCertificationRecordSchema = z.object({
  board: z.string(),
  specialty: z.string(),
...
export type BoardCertificationRecord = z.infer<typeof BoardCertificationRecordSchema>;

export const LicenseRecordSchema = z.object({
  state: z.string(),
  status: z.enum(['ACTIVE', 'RESTRICTED', 'SUSPENDED', 'PROBATION', 'EXPIRED']),
  expiresAt: z.string(),
});

export type LicenseRecord = z.infer<typeof LicenseRecordSchema>;

export const ProcedureVolumeRecordSchema = z.object({
...
export type ProcedureVolumeRecord = z.infer<typeof ProcedureVolumeRecordSchema>;

export const DeaRegistrationRecordSchema = z.object({
  number: z.string(),
  schedules: z.array(z.string()),
  expiresAt: z.string().optional(),
});

export type DeaRegistrationRecord = z.infer<typeof DeaRegistrationRecordSchema>;

const CustomAttributeValueSchema = z.union([
  z.string(),
  z.number(),
  z.boolean(),
...
export const ClinicianSnapshotSchema = z.object({
  clinicianDid: z.string(),
  specialty: z.string(),
  subspecialties: z.array(z.string()).optional(),
  boardCertifications: z.array(BoardCertificationRecordSchema).optional(),
  licenses: z.array(LicenseRecordSchema).optional(),
  deaRegistrations: z.array(DeaRegistrationRecordSchema).optional(),
  procedureVolumes: z.array(ProcedureVolumeRecordSchema).optional(),
  customAttributes: z.record(CustomAttributeValueSchema).optional(),
});

export type ClinicianSnapshot = z.infer<typeof ClinicianSnapshotSchema>;
