 ...
 */
export declare const TenantRegionSchema: z.ZodObject<{
    tenantId: z.ZodString;
    tenantName: z.ZodString;
    homeRegion: z.ZodNativeEnum<typeof Region>;
    allowedRegions: z.ZodEffects<z.ZodArray<z.ZodNativeEnum<typeof Region>, "many">, Region[], Region[]>;
    dataResidencyEnforced: z.ZodDefault<z.ZodBoolean>;
    crossRegionSyncEnabled: z.ZodDefault<z.ZodBoolean>;
    regulatoryFramework: z.ZodNativeEnum<typeof RegulatoryFramework>;
    baaExecuted: z.ZodDefault<z.ZodBoolean>;
    dpoAssigned: z.ZodOptional<z.ZodString>;
    dpiaCompleted: z.ZodDefault<z.ZodBoolean>;
    migratedFrom: z.ZodOptional<z.ZodNativeEnum<typeof Region>>;
    migrationDate: z.ZodOptional<z.ZodDate>;
    migrationReason: z.ZodOptional<z.ZodString>;
    ...
    createdAt: Date;
    updatedAt: Date;
    dpoAssigned?: string | undefined;
    migratedFrom?: Region | undefined;
    migrationDate?: Date | undefined;
    ...
    allowedRegions: Region[];
    regulatoryFramework: RegulatoryFramework;
    dataResidencyEnforced?: boolean | undefined;
    crossRegionSyncEnabled?: boolean | undefined;
    baaExecuted?: boolean | undefined;
    dpoAssigned?: string | undefined;
    dpiaCompleted?: boolean | undefined;
    migratedFrom?: Region | undefined;
    migrationDate?: Date | undefined;
    migrationReason?: string | undefined;
 ...
 */
export declare const TenantRegionCreateSchema: z.ZodObject<{
    tenantId: z.ZodString;
    tenantName: z.ZodString;
    homeRegion: z.ZodNativeEnum<typeof Region>;
    dataResidencyEnforced: z.ZodDefault<z.ZodBoolean>;
    ...
    allowedRegions: z.ZodOptional<z.ZodArray<z.ZodNativeEnum<typeof Region>, "many">>;
}, "strip", z.ZodTypeAny, {
    tenantId: string;
    tenantName: string;
    homeRegion: Region;
    ...
    baaExecuted: boolean;
    dpiaCompleted: boolean;
    allowedRegions?: Region[] | undefined;
    dpoAssigned?: string | undefined;
    migratedFrom?: Region | undefined;
    migrationDate?: Date | undefined;
    migrationReason?: string | undefined;
 ...
 */
export declare const TenantRegionUpdateSchema: z.ZodObject<{
    tenantId: z.ZodString;
    allowedRegions: z.ZodOptional<z.ZodArray<z.ZodNativeEnum<typeof Region>, "many">>;
    crossRegionSyncEnabled: z.ZodOptional<z.ZodBoolean>;
    baaExecuted: z.ZodOptional<z.ZodBoolean>;
    dpoAssigned: z.ZodOptional<z.ZodString>;
    dpiaCompleted: z.ZodOptional<z.ZodBoolean>;
    notes: z.ZodOptional<z.ZodString>;
